                ...
                <div id="myDirectChat" class="box box-warning direct-chat direct-chat-warning">
                  <div class="box-header with-border">
                    ...
                    <div class="box-tools pull-right">
                      <span data-toggle="tooltip" title=" <?php echo $qc; ?> New Messages" class='badge bg-yellow'><?php echo $crud->countAllById3('chat','status','0'); ?></span>
                  ...
                  <div class='contacts-list-info bg-primary'>
                    <span class='contacts-list-name text-black'>
                     ...
                     <small class='contacts-list-date pull-right text-black'>
                       <span class='badge bg-light'><?php echo $crud->countAllById2('chat',$person['id']); ?></span> &nbsp;&nbsp;&nbsp;
                      <?php echo $dx['date_created']; ?></small>
                   </span>
